...
const EventCreationWizard: React.FC<EventCreationWizardProps> = ({ onClose, onSave }) => {
  ...
  const defaultCategories: EventCategory[] = [
    { id: '1', name: 'Technology', description: 'Tech conferences and meetups', color: '#3B82F6', icon: 'Laptop', isDefault: true },
    { id: '2', name: 'Business', description: 'Business and networking events', color: '#10B981', icon: 'Briefcase', isDefault: true },
    { id: '3', name: 'Arts & Culture', description: 'Cultural and artistic events', color: '#F59E0B', icon: 'Palette', isDefault: true },
    { id: '4', name: 'Sports', description: 'Sports and fitness events', color: '#EF4444', icon: 'Trophy', isDefault: true },
    { id: '5', name: 'Education', description: 'Educational workshops and seminars', color: '#8B5CF6', icon: 'BookOpen', isDefault: true },
    { id: '6', name: 'Entertainment', description: 'Entertainment and social events', color: '#EC4899', icon: 'Music', isDefault: true }
  ];
                ...
                {[
                  ...
                  return (
                    <button
                      key={type.value}
                      type="button"
                      onClick={() => setEventData({ ...eventData, eventType: type.value as any })}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              {eventData.startDate && (
                <p className="text-sm text-blue-700">
                  Event starts: {new Date(eventData.startDate).toLocaleString('en-US', { 
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setEventData({ ...eventData, virtualEventUrl: e.target.value })}
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h4 className="font-medium text-yellow-800 mb-2">Image Guidelines</h4>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                {[
                  { value: 'public', label: 'Public', description: 'Anyone can find and view this event' },
                  ...
                  <label key={option.value} className="flex items-start space-x-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setEventData({ ...eventData, visibility: e.target.value as any })}
                      className="mt-1"
                    />
                    <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { key: 'allowWaitlist', label: 'Enable Waitlist', description: 'Allow people to join waitlist when sold out' },
                  { key: 'requireApproval', label: 'Require Approval', description: 'Manually approve each registration' },
                  { key: 'collectAttendeeInfo', label: 'Collect Attendee Info', description: 'Gather additional information from attendees' },
                  { key: 'enableQRCode', label: 'QR Code Check-in', description: 'Generate QR codes for easy check-in' },
                  { key: 'enableSocialSharing', label: 'Social Sharing', description: 'Allow attendees to share on social media' },
                  { key: 'enableComments', label: 'Event Comments', description: 'Let attendees leave comments and questions' }
                ].map((setting) => (
                  <label key={setting.key} className="flex items-start space-x-3 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={eventData.settings?.[setting.key as keyof typeof eventData.settings] || false}
                      onChange={(e) => setEventData({
                        ...eventData,
                        settings: {
                          ...eventData.settings!,
          ...
          <div className="space-y-6">
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-medium text-green-800">Event Ready for Review</h3>
              </div>
              <p className="text-green-700">
                Your event has been configured successfully. Review the details below and choose to save as draft or publish immediately.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium capitalize">{eventData.eventType}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Category:</span>
                  <span className="font-medium">{eventData.category?.name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Visibility:</span>
                  <span className="font-medium capitalize">{eventData.visibility}</span>
                </div>
                {eventData.startDate && (
                  <div className="flex justify-between">
